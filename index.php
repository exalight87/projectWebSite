...
<html class="no-js" lang="en">
  ...
  <body>
    <div class="title-bar" data-responsive-toggle="menu-site" data-hide-for="medium">
      <button class="menu-icon" type="button" data-toggle></button>
      <div class="title-bar-title">Menu</div>
    </div>
    <div class="top-bar" id="menu-site">
      <div class="row">
        <div class="top-bar-left">
          <ul class="vertical medium-horizontal menu " data-back-button="<li class='js-drilldown-back'><a>Retour</a></li>" data-responsive-menu="drilldown medium-dropdown">
            ...
            <li class="show-for-small-only"><a href="#">connexion</a></li>
          </ul>
        </div>
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="medium-4 columns">
            ...
            <p>Faites vos menus en un clin d'oeil.<br>Une grande gamme d'aliments vous est proposé</p>
          </div>
          <div class="medium-4 columns">
            <div class="icone_div">
          ...
          <div class="medium-4 columns">
            ...
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta soluta libero atque numquam consequatur, maiores voluptatem, ducimus, recusandae distinctio, eum quis veritatis officia non esse eos aut et cupiditate. Voluptatibus!
          </div>
        </div>
        </div>
      </div>
